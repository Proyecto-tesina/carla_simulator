...
class Hud(object):
    ...
    def tick(self, world, clock):
        ...
        if len(vehicles) > 1:
            ...
            vehicles = [
                (self._distance_between_vehicles(x.get_location(), transform), x)
                for x in vehicles
    ...
    def _distance_between_vehicles(self, vehicle1, vehicle2):
        dist = math.sqrt(
            (vehicle1.x - vehicle2.location.x) ** 2
    ...
    def _get_control_info(self, control):
        if isinstance(control, carla.VehicleControl):
            ...
            info_text = [("Speed:", control.speed, 0.0, 5.556), ("Jump:", control.jump)]
        return info_text
